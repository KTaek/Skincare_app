 ...
 *
 * ⚠️ **이 앱은 지금 ghostUri를 넘기지 않는다.** 반투명하게 깔린 지난 사진이 지금 피부와 섞여
 *    보여서 정작 무엇을 찍고 있는지 알아보기 어려웠기 때문이다(MonitorCaptureScreen 주석).
 *    그래서 실제로 그려지는 것은 항상 아래 표준 도형이고, 정렬 게이트도 같은 표준 구도를 잰다.
 *    고스트 경로는 되살릴 때를 위해 남겨 둔다 — 되살리면 게이트 목표도 함께 그 사진이 된다.
 */
