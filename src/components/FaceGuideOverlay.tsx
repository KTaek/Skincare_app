...
import { standardRoi } from '../ai/faceFrame';

/**
 * 얼굴 촬영 가이드 — 지난 사진을 화면 전체에 반투명하게 깔고, 거기 겹쳐 맞추게 한다.
 *
...
export default function FaceGuideOverlay({
  ...
  const box = guideBox(size.w, size.h, imageWidth, imageHeight);
 ...
 */
function guideBox(screenW: number, screenH: number, imageW: number, imageH: number) {
